...
public abstract class ChildFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        RelativeLayout fragmentLayout = (RelativeLayout) super.onCreateView(inflater, container, savedInstanceState),
        ...
        RelativeLayout.LayoutParams fragmentLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        fragmentLayoutParams.addRule(RelativeLayout.BELOW, R.id.sub_child_fragment_title_bar);
        layout.addView(fragmentLayout, fragmentLayoutParams);
